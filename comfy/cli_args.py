...
attn_group.add_argument("--use-sage-attention3", action="store_true", help="Use SageAttention3 FP4 attention. Requires the sageattn3 package and a Blackwell (RTX 50 series) or newer GPU.")
